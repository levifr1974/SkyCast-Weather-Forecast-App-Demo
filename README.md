...
[![Made with Love](https://img.shields.io/badge/Made%20with-❤️-red?style=for-the-badge)](https://github.com/ahmadrazaattari)

**A modern, elegant weather forecast application delivering real-time weather data with a beautiful user interface.**

[🚀 Live Demo](https://ahmadrazaattari.github.io/SkyCast-Weather-Forecast-App-Demo/) • [📖 Features](#-features) • [🛠️ Installation](#️-installation) • [🗺️ Roadmap](#️-roadmap)
...
| Metric | Description |
|--------|-------------|
| 🌡️ **Feels Like** | Perceived temperature with high/low range |
| 💨 **Wind Speed** | Current wind speed with direction heading |
| 💧 **Humidity** | Atmospheric humidity percentage |
| ☀️ **UV Index** | Ultraviolet radiation intensity |
| 👁️ **Visibility** | Atmospheric visibility distance |
| 📊 **Pressure** | Atmospheric pressure readings |
| 🌧️ **Precipitation** | Rainfall/snowfall probability |
| 🌬️ **Air Quality** | Air quality index (AQI) |
| 🌅 **Sunrise** | Daily sunrise time |
| 🌇 **Sunset** | Daily sunset time |
| ☁️ **Cloud Cover** | Cloud coverage percentage |
| 🌪️ **Wind Gusts** | Maximum wind gust speeds |

### 📅 5-Day Strategic Outlook
...
3. **Toggle Temperature Units**: Switch between °C and °F using the toggle button
